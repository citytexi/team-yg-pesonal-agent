...
- **:api** — 공개 계약만. 목적지 `NavKey`(예: `NavKeyLogin`, `NavKeySegmentation`, `NavKeyCameraCustom`)뿐. `@Serializable`. Android library + serialization만 적용(`ModuleFeatureApiConventionPlugin`).
