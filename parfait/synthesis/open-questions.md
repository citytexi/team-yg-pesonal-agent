...
- **해소 메모**: 반영처 — [navigation-flow](../architecture/navigation-flow.md) "그룹 생성·참여 플로우" ·
  [a005 스펙](../specs/archive/2026-07-29-a005-group-create.md)·[s102 스펙](../specs/archive/2026-07-22-s102-group-nickname.md)의
...
- **해소 메모**: 정하면 [navigation-flow](../architecture/navigation-flow.md) "그룹 생성·참여 플로우"의
  진입 사유 인자 항목과 [ygalert 스펙](../specs/archive/2026-07-23-ygalert.md) 노출 정책 절에 적는다.
...
- **항목**: 머지되면 delta 감사에서 볼 것 — ① [g001 스펙](../specs/archive/2026-08-01-g001-group-list.md)
...
- **해소 메모**: ①과 ③은 예고한 대로 들어왔다. 반영처는
  [g001 스펙](../specs/archive/2026-08-01-g001-group-list.md) 「에러·새로고침」·정책 대조 표,
  [screen-resume-refetch 스펙](../specs/archive/2026-08-17-screen-resume-refetch.md)의 실패 규칙 표,
...
- **해소 메모**: ①이 먼저다. 정해지면 [c001-canvas-today-detail 스펙](../specs/archive/2026-08-17-c001-canvas-today-detail.md)
...
- **해소 메모**: 그림 상자 밖으로 테두리가 나간 토핑을 눌러 옛 판정이면 안 눌렸을 자리가 눌리는지
  확인하면 닫는다. 닫을 때 [토핑 알파 판정 스펙](../specs/archive/2026-08-26-topping-alpha-hit-test.md)의
  판정 규칙 절에 반영한다.
...
- **ID**: OQ-P-399
- **출처**: [segmentation-retry-recovery 스펙](../specs/archive/2026-09-10-segmentation-retry-recovery.md)
...
- **ID**: OQ-P-400
- **출처**: [segmentation-retry-recovery 스펙](../specs/archive/2026-09-10-segmentation-retry-recovery.md) as-built 배너의
  「기록해 둔 결정」·「다음 라운드로 미룬 항목」 × [계획](../plans/archive/2026-09-10-segmentation-retry-recovery.md)
...
- **출처**: 커밋 `3217e62f7`(`feat: 실패 화면의 편집 없이 사용을 직접 편집으로 바꿔 C-104 로 바로 보낸다`, PR #487
  ...
  [c103-error-use-original 스펙](../specs/archive/2026-09-05-c103-error-use-original.md). 그 스펙은 「편집 없이 사용」을
