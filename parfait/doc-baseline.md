...
- **커밋**: `c37dc2b4c` (`Merge pull request #490 from mash-up-kr/chore/bump-version-code-11`)
- **요약**: **선작성 as-built 가 머지 코드와 한 줄도 어긋나지 않았고, 새로 드러난 것은 코드가 아니라 버전 표식이다**
  ...
  **#489 — 권한을 한 번도 묻지 않던 두 화면이 진입할 때 묻는다.** 문서 저장소 PR #406 이 머지 직전에
  [c101](specs/archive/2026-08-01-c101-camera-picture-confirm.md)·[c102](specs/archive/2026-08-04-c102-custom-gallery-picker.md)
  ...
  **조치**: c101·c102 스펙 미머지 표기 걷기 + `verified` 2026-09-11 · [specs/README](specs/README.md) 두 행 ·
...
- **미머지 추적 항목**: **하나**(`feature/debug-mode`, OQ-P-311 계보).
  ...
  **parfait 문서가 걸린 브랜치 중 회차를 넘겨 남는 것**만 센다.
  ...
  [그 계획](plans/2026-08-28-login-debug-mode.md)은 `draft` 로 남는다. 이번 회차가 확인한
