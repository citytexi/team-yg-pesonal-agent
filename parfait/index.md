...
- **[`doc-baseline.md`](doc-baseline.md)** — 문서를 마지막으로 검증한 `develop` 커밋 해시(SoT) + "develop 기준 문서 점검" 절차. 현재 기준선 `25f7c17`(2026-08-09, #219 유닛 테스트 기반 구조 — 컨벤션 플러그인 3종·`:core:testing`·CI 워크플로 2종까지).
