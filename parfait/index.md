...
- **[`doc-baseline.md`](doc-baseline.md)** — 문서를 마지막으로 검증한 `develop` 커밋 해시(SoT) + "develop 기준 문서 점검" 절차. 현재 기준선 `90c651e`(2026-08-04, #190 서버 계약 정합 envelope·`ApiCaller`·암호화 토큰 저장까지).
