...
- **[`doc-baseline.md`](doc-baseline.md)** — 문서를 마지막으로 검증한 `develop` 커밋 해시(SoT) + "develop 기준 문서 점검" 절차. 현재 기준선 `ebad098`(2026-08-06, #197 14 엔드포인트 Service·remote DataSource·domain VO 표면까지).
