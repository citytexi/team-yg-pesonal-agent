...
- **[`doc-baseline.md`](doc-baseline.md)** — 문서를 마지막으로 검증한 `develop` 커밋 해시(SoT) + "develop 기준 문서 점검" 절차. 현재 기준선 `ada2774`(2026-08-04, #192 S-002 계정 정보 화면 + `clearFocusOnTap` + S-001 Danger Zone 이관까지).
