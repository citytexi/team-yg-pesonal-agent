...
용법:
    python3 parfait/script/check_links.py                 # repo 전체
    python3 parfait/script/check_links.py parfait bot     # 하위 경로만
    python3 parfait/script/check_links.py --quiet         # 깨진 것만 출력
