...
| `YGToppingCutoutImage` — 위 `YGToppingImage`와 **다른 물건**(아래 항목), 브랜치 `feature/#270-topping-border-contract`·develop 미머지 | `component/ygtoppingcutout/` | [ADR-0025](../adr/0025-topping-border-as-server-field.md) · [c106-topping-place-api](../specs/2026-08-20-c106-topping-place-api.md) |
