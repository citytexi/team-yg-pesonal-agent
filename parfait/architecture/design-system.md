...
component/
  ...
  ygfloatingbar/          ← YGFloatingBar* 4변형 + private 컨테이너·버튼 2종 (#188 develop 머지) · Title 변형 추가(#381, develop 미머지)
...
| `YGFloatingBar{BackClose,Close,Edit,EditTab,Title}`(`Title`은 #381, develop 미머지) | `component/ygfloatingbar/` | [designsystem-bar-listdate-components](../specs/archive/2026-08-01-designsystem-bar-listdate-components.md) |
