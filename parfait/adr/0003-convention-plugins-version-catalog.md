...
📌 **그 뒤로도 카탈로그에서 손으로 올라간다**(2026-09-10, PR #483 — `appVersionCode` 9,
`appVersionName` 1.1.2. 직전은 2026-09-08 PR #470 의 8·1.1.1). 프리뷰 쪽 두 값은 그대로다.
...
커밋이라 두 계보가 최신 구간에서는 갈라지지 않는다. ⚠️ **그래도 표식 문제는 남는다**(OQ-P-310) —
